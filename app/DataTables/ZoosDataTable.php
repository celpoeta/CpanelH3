...
class ZoosDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return datatables()
            ...
            ->editColumn('category_id', function (Zoo $blog) {
     ...
     *
     * @param \App\Models\Zoo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Zoo $model): QueryBuilder
    {
        // return $model->newQuery();
        return $model->newQuery()->select(['zoos.*', 'blog_categories.name as cat_name'])
            ->join('blog_categories', 'blog_categories.id', '=', 'zoos.category_id')->orderBy('id', 'asc');
    }
    ...
    public function html(): HtmlBuilder
    {
        ...
        if ($canCreateBlog) {
            $buttonsConfig[] =  [
                ...
                'action' => "function ( e, dt, node, config ) { window.location = '" . route('zoos.create') . "'; }",
            ];
        }
        $exportButtonConfig = [];
        if ($canExportBlog) {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('common_name')->title(__('Title')),
