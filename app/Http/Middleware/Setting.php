...
class Setting
{
    public function handle(Request $request, Closure $next)
    {
        ...
        config([
            ...
            'google-calendar.auth_profiles.service_account.credentials_json' => Storage::path('/google_json_file/'.UtilityFacades::getsettings('google_calendar_json_file')),
            'google-calendar.auth_profiles.oauth.credentials_json' => Storage::path('/google_json_file/'.UtilityFacades::getsettings('google_calendar_json_file')),
            'google-calendar.auth_profiles.oauth.token_json' => Storage::path('/google_json_file/'.UtilityFacades::getsettings('google_calendar_json_file')),
