        ...
        <select class="btn btn-primary me-2 nice-select"
            ...
            @foreach ($languages as $language)
                <option class="" @if ($lang == $language) selected @endif
                    value="{{ route('view.blog', ['slug' => $slug, 'lang' => $language]) }}">{{ Str::upper($language) }}
                </option>
            @endforeach
        </select>
    </li>
            ...
            <div class="container">
                <div class="common-banner-content">
                    ...
                    <ul class="back-cat-btn d-flex align-items-center justify-content-center">
                        ...
                        <li><a href="javascript:void(0)">{{ __('Blogs') }}</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-12">
                        <div class="about-user d-flex align-items-center">
                            <div class="abt-user-info d-flex align-items-center">
                                <div class="abt-image">
                                    <img src="{{ Storage::url($user->avatar) }}" alt="client-image">
                                </div>
                                <h6>
        ...
        <section class="article-page-slider ">
            <div class="container">
                ...
                <div class="article-slider">
                    @foreach ($all_blogs as $one_blog)
                        <div class="article-card">
                            <div class="article-card-inner">
                                <div class="article-card-image">
                                    <a href="#">
                                        <img src="{{ isset($one_blog->images) ? Storage::url($one_blog->images) : asset('vendor/landing-page2/image/blog-card-img-2.png') }}"
                                            alt="blog-card-image">
                                    </a>
                                </div>
                                <div class="article-card-content">
                                    <div class="author-info d-flex align-items-center justify-content-between">
                                        <div class="date d-flex align-items-center">
                                            ...
                                            <span>{{ App\Facades\UtilityFacades::date_time_format($one_blog->created_at) }}</span>
                                        </div>
                                    </div>
                                    <h3>
                                        <a href="{{ route('view.blog', $one_blog->slug) }}">
                                            {{ isset($one_blog->title) ? $one_blog->title : __('Setting up Form builder in Laravel') }}</a>
                                    </h3>
                                    <p> {!! isset($one_blog->short_description)
                                        ? $one_blog->short_description
                                        : __(
