                ...
                <div class="col-xl-3">
                    <div class="card sticky-top">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            @include('landingpage.landingpage_sidebar')
                        </div>
                    </div>
                </div>
                <div class="col-xl-9">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @if (is_array($footer_main_menus) || is_object($footer_main_menus))
                                            @php
                                                $ff_no = 1;
                                            @endphp
                                            @foreach ($footer_main_menus as $key => $footer_main_menu)
                                                <tr>
                                                    <td>{{ $ff_no++ }}</td>
                                                    <td>{{ $footer_main_menu['menu'] }}</td>
                                                    <td>{{ $footer_main_menu['slug'] }}</td>
                                                    <td>
                                                        <span class="d-flex">
                                                            <div>
                                                                <a href="javascript:void(0);"
                                                                    data-url="{{ route('footer.main.menu.edit', $footer_main_menu->id) }}"
                                                            ...
                                                            {!! Form::open([
                                                                'method' => 'GET',
                                                                'class' => 'd-inline',
                                                                'route' => ['footer.main.menu.delete', $footer_main_menu->id],
                                                                'id' => 'delete-form-' . $footer_main_menu->id,
                                                            ]) !!}
                                                            <a href="javascript:void(0);"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @if (is_array($footer_sub_menus) || is_object($footer_sub_menus))
                                            @php
                                                $ff_no = 1;
                                            @endphp
                                            @foreach ($footer_sub_menus as $key => $footer_sub_menu)
                                                @php
                                                    $parent_name = App\Models\FooterSetting::select('menu')
                                                        ->where('id', $footer_sub_menu['parent_id'])
                                                        ->first();
                                                @endphp
                                                <tr>
                                                    <td>{{ $ff_no++ }}</td>
                                                    <td>{{ $footer_sub_menu['menu'] }}</td>
                                                    <td>{{ $footer_sub_menu['slug'] }}</td>
                                                    <td>{{ $parent_name['menu'] }}</td>
                                                    <td>
                                                        <span class="d-flex">
                                                            <div>
                                                                <a href="{{ route('footer.sub.menu.edit', $footer_sub_menu->id) }}"
                                                                    data-ajax-popup="true" data-bs-toggle="tooltip"
                                                                    data-bs-placement="bottom"
                                                            ...
                                                            {!! Form::open([
                                                                'method' => 'GET',
                                                                'class' => 'd-inline',
                                                                'route' => ['footer.sub.menu.delete', $footer_sub_menu->id],
                                                                'id' => 'delete-form-' . $footer_sub_menu->id,
                                                            ]) !!}
                                                            <a href="javascript:void(0);"
                                                                class="btn btn-sm small btn btn-danger show_confirm"
                                                                data-bs-toggle="tooltip" data-bs-placement="bottom"
