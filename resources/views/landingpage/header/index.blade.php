                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a href="javascript:void(0);" data-url="{{ route('header.menu.create') }}"
                                        ...
                                        class="btn btn-sm btn-primary mx-1 header_menu_create"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @if (is_array($header_settings) || is_object($header_settings))
                                            @php
                                                $ff_no = 1;
                                            @endphp
                                            @foreach ($header_settings as $key => $headerMenu)
                                                <tr>
                                                    <td>{{ $ff_no++ }}</td>
                                                        ...
                                                        <span class="d-flex">
                                                            <div>
                                                                <a href="javascript:void(0);"
                                                                    ...
                                                                    class="btn btn-sm btn-primary mx-1 header_menu_edit"
                                                                    data-bs-original-title="{{ __('Create') }}">
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            $('body').on('click', '.header_menu_create', function() {
        ...
        $(document).ready(function() {
            $('body').on('click', '.header_menu_edit', function() {
                var action = $(this).data('url');
                var modal = $('#common_modal');
                $.get(action, function(response) {
