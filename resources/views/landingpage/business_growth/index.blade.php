                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @if (is_array($business_growth_view_settings) || is_object($business_growth_view_settings))
                                            @php
                                                $ff_no = 1;
                                            @endphp
                                            @foreach ($business_growth_view_settings as $key => $business_growth_view_setting)
                                                <tr>
                                                    <td>{{ $ff_no++ }}</td>
                                                    <td>{{ $business_growth_view_setting['business_growth_view_name'] }}</td>
                                                    <td>{{ $business_growth_view_setting['business_growth_view_amount'] }}</td>
                                                    <td>
                                                        <span>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        @if (is_array($business_growth_settings) || is_object($business_growth_settings))
                                            @php
                                                $ff_no = 1;
                                            @endphp
                                            @foreach ($business_growth_settings as $key => $business_growth_setting)
                                                <tr>
                                                    <td>{{ $ff_no++ }}</td>
                                                    <td>{{ $business_growth_setting['business_growth_title'] }}</td>
                                                    <td>
                                                        <span>
                                                            <a href="javascript:void(0);"
