{{ Form::model(null, ['route' => ['business.growth.update', $key], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                {{ Form::label('business_growth_title', __('Business Growth Title'), ['class' => 'form-label']) }}
                {!! Form::text('business_growth_title', $business_growth_setting['business_growth_title'], [
                    'class' => 'form-control',
                    'rows' => '1',
