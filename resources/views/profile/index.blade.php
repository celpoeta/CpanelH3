                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="avatar me-3">
                                    {{-- {!! Form::image($user->avatar_image, null, [
                                        'class' => 'img-user wid-80 rounded-circle',
                                    ]) !!} --}}
                                    <img src="{{ isset($user->avatar) ?  Storage::url($user->avatar) :  $user->avatar_image }}" class="img-user wid-80 rounded-circle">
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div id="avatar-updater" class="col-xs-12 d-none">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                {!! Form::text('avatar-url', route('update-avatar', Auth::user()->id), ['class' => 'd-none']) !!}
                                                ...
                                                @if (empty(auth()->user()->loginSecurity))
                                                    ...
                                                    <div class="p-0 row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            {!! Html::link('#collapseExample', __('Setup Instruction'), [
