            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                                        ...
                                        <div class="pt-0 card-body">
                                            <div class="setting-card">
                                                <div class="seo-image-content">
                                                    <a href="{{ Utility::getsettings('meta_image') ? Storage::url(Utility::getsettings('meta_image')) : Storage::url('seo_image/meta_image.jpg') }}"
                                                        target="_blank">
                                                        <img id="meta"
                                                            src="{{ Utility::getsettings('meta_image') ? Storage::url(Utility::getsettings('meta_image')) : Storage::url('seo_image/meta_image.jpg') }}"
                                                            width="250px">
                                                    </a>
                                                </div>
                    ...
                    <div id="cache-setting" class="">
                        <div class="card" id="settings-card">
                            <div class="card-header">
                                ...
                                <small>
                                    {{ __('This is a page meant for more advanced users, simply ignore it if you don\'t
                                ...
                                <div class="row cookieDiv">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a href="{{ asset(Storage::url('sample/cookie_data.csv')) }}"
                    ...
                    <div id="google-calender-setting" class="card">
                        <div class="col-md-12">
                            {{ Form::open(['route' => 'settings/GoogleCalender/update', 'method' => 'POST', 'data-validate', 'novalidate', 'enctype' => 'multipart/form-data']) }}
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col-6">
                            ...
                            <div class="card-body google_calender">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                        ...
                                        {{-- <input type="file" class="" name="google_calendar_json_file"
                                            id="file"> --}}
                    ...
                    <div id="google-map-setting" class="card">
                        <div class="col-md-12">
                            {{ Form::open(['route' => 'settings/GoogleMap/update', 'method' => 'POST', 'data-validate', 'novalidate', 'enctype' => 'multipart/form-data']) }}
                            <div class="card-header">
                                <div class="row d-flex align-items-center">
                                    <div class="col-6">
                                    ...
                                    @foreach ($notifications_settings as $notifications_setting)
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div>
                                                        <span name="title" class="form-control"
                                                            ...
                                                            value="{{ $notifications_setting->id }}">
                                                            {{ $notifications_setting->title }}</span>
                                                    </div>
                                                </td>
                                                @if ($notifications_setting->email_notification != 2)
                                                    <td class="text-end">
                                                        <div class="form-check form-switch d-inline-block">
                                                            {!! Form::checkbox('email_notification', null, $notifications_setting->email_notification == 1 ? true : false, [
                                                                'class' => 'form-check-input chnageEmailNotifyStatus',
                                                                'data-url' => route('notification.status.change', $notifications_setting->id),
                                                            ]) !!}
                                                        </div>
                                                    </td>
                                                @else
                                                ...
                                                @if (
                                                    $notifications_setting->status == 2 &&
                                                        $notifications_setting->title != 'testing purpose' &&
                                                        $notifications_setting->title != 'new Enquire details' &&
                                                        $notifications_setting->title != 'new survey details')
                                                @else
                                                    <td class="text-end">
                                                        <div class="form-check form-switch d-inline-block">
                                                            {!! Form::checkbox('notify', null, $notifications_setting->notify == 1 ? true : false, [
