                            ...
                            <div class="form-group">
                                ...
                                <div class="uploaded-pics gy-3 row">
                                    ...
                                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-5 theme-view-card selected-theme">
                                        <div class="theme-view-inner">
                                            <div class="theme-view-img">
                                                <img data-id="theme1" src="{{ Utility::getsettings('document_theme1') ? Storage::url(Utility::getsettings('document_theme1')) : Storage::url('appLogo/200x100.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-5 theme-view-card">
                                        <div class="theme-view-inner">
                                            <div class="theme-view-img">
                                                <img data-id="theme2" src="{{ Utility::getsettings('document_theme2') ? Storage::url(Utility::getsettings('document_theme2')) : Storage::url('appLogo/200x100.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
