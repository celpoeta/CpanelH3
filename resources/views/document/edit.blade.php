...
@section('content')
    <div class="row">
        <div class="m-auto col-lg-12 card-main">
            {!! Form::model($document, [
                                    ...
                                    <div
                                        ...
                                        <div class="theme-view-inner">
                                            <div class="theme-view-img">
                                                <img data-id="theme1" src="{{ Storage::url('document_theme/Stisla.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <div class="theme-view-inner">
                                            <div class="theme-view-img">
                                                <img data-id="theme2" src="{{ Storage::url('document_theme/Editor.png') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
