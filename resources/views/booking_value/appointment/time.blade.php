                            ...
                            <table class="table mt-0 table-responsive invoice-table invoice-order table-borderless">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ Utility::date_format($booking_value->booking_slots_date) }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{ __('Booking Slots') }} :</th>
                                        <td>{{ $booking_value->booking_slots }}</td>
                                    </tr>
                                    <tr>
                                        <th>{{ 'Status' }} :</th>
                                        <td>
                                            ...
                                            @elseif($booking_value->booking_status == 0)
                        ...
                        <div class="col-sm-4">
                            @if ($booking_value->booking_status == 1)
                                {!! Form::open([
                                    'method' => 'DELETE',
                                    'class' => 'd-inline',
                                    'route' => ['appointment.slot.cancel', $booking_value->id],
                                    'id' => 'delete-form-' . $booking_value->id,
                                ]) !!}
                                <a href="#" class="btn btn-sm small btn-danger show_confirm" data-bs-toggle="tooltip"
                                    data-bs-placement="bottom" id="delete-form-{{ $booking_value->id }}"
                                    ...
                                    @elseif($row->type == 'video')
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <form action="{{ route('selfie.image.download', $booking_value->id) }}"
                                                    method="GET">
