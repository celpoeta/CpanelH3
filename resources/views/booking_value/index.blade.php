...
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Submitted Bookings of ' . ' ' . $bookings_details->business_name) }}</h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">{!! Html::link(route('home'), __('Dashboard'), ['']) !!}</li>
            <li class="breadcrumb-item">{{ __('Submitted Bookings of ' . ' ' . $bookings_details->business_name) }}</li>
        </ul>
    </div>
@endsection
@section('content')
    <div class="row">
        <div class="main-content">
            <section class="section">
                @if (!empty($bookings_details->logo))
                    <div class="text-center gallery gallery-md">
                        <img id="app-dark-logo" class="float-none gallery-item"
                            src="{{ Storage::exists($bookings_details->logo)
                                ? asset('storage/app/' . $bookings_details->logo)
                                : Storage::url('uploads/appLogo/78x78.png') }}"
                            alt="form_logo">
                    </div>
                @endif
                <h2 class="text-center">{{ $bookings_details->title }}</h2>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 responsive-search">
                                            <div class="form-group row d-flex justify-content-start">
                                                ...
                                                {!! Form::hidden('booking_id', $bookings_details->id, ['id' => 'booking_id']) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="mt-5 col-xl-12">
                                            <div class="table-responsive">
                                                ...
                                                {{ Form::hidden('booking_id', $bookings_details->id) }}
