    ...
    <select class="btn btn-primary me-2 nice-select"
        ...
        @foreach ($languages as $language)
            <option class="" @if ($lang == $language) selected @endif
                value="{{ route('landingpage', $language) }}">{{ Str::upper($language) }}
            </option>
        @endforeach
    </select>
</li>
...
<main class="home-wrapper">
    @if (Utility::getsettings('apps_setting_enable') == 'on')
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="banner-image">
                            <img src="{{ Utility::getsettings('apps_image') ? Storage::url(Utility::getsettings('apps_image')) : asset('vendor/landing-page2/image/slider-main-image.png') }}"
        ...
        @if (isset($apps_multiple_image_settings))
                ...
                <div class="container">
                    <div class="client-logo-wrap">
                        <div class="client-logo-slider slick-slider">
                            @foreach ($apps_multiple_image_settings as $apps_multiple_image_setting)
                                <div class="client-logo-iteam">
                                    <a href="javascript:void(0);">
                                        <img src="{{ Storage::url($apps_multiple_image_setting->apps_multiple_image) }}"
        ...
        <section class="counter-sec pb">
            <div class="container">
                ...
                <div class="main-counter-div">
                    <div class="row">
                        @if (isset($business_growths_view_settings))
                            @foreach ($business_growths_view_settings as $business_growths_view_setting)
                                <div class="col-sm-4 col-12 ">
                                    <div class="counter-iteam counter text-center">
                                        <h3>
                                            <span class="count" data-target="2">
                                                {{ $business_growths_view_setting->business_growth_view_amount }}
                                            </span>
                                        </h3>

                                        <span class="counter-content">
                                            {{ $business_growths_view_setting->business_growth_view_name }}</span>
                                    </div>
                                </div>
                            @endforeach
                        @else
            ...
            <div class="advance-feature">
                <div class="advance-feature-slider">
                    @if (isset($business_growths_settings))
                        @foreach ($business_growths_settings as $business_growths_setting)
                            <div>
                                <div class="advance-feature-card">
                                    <div class="advance-card-inner d-flex align-items-center">
                                        ...
                                        <div class="advance-card-content">
                                            <p> {{ $business_growths_setting->business_growth_title }} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="author-info d-flex align-items-center justify-content-between">
                                        <div class="author-name d-flex align-items-center">
                                            <div class="author-img">
                                                <img src="{{ isset($user->avatar) ? Storage::url($user->avatar) : __('vendor/landing-page2/image/test-client-image.png') }}"
                                                    alt="client-image">
                                            </div>
                                                <span>{{ $user->name }}</span>
                                        </div>
