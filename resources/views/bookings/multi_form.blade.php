...
@else
                            ...
                            <div class="col-lg-6 col-md-12 col-12">
                                <div class="signature-pad-body">
                                    ...
                                    <div class="buttons signature_buttons">
                                        ...
                                        <button id="showPointsToggle{{ $row->name }}" type="button"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom"
    ...
    @endforeach
    @if (!isset($booking_value) && $booking->payment_status == 1)
        @if (!isset($booking_value) && $booking->payment_type == 'stripe')
            <div class="strip">
        ...
        @elseif(!isset($booking_value) && $booking->payment_type == 'razorpay')
            <div class="razorpay">
                <p>{{ __('Make Payment') }}</p>
        ...
        @elseif(!isset($booking_value) && $booking->payment_type == 'paypal')
            <div class="paypal">
                <p>{{ __('Make Payment') }}</p>
                <input type="hidden" name="payment_id" id="payment_id">
                <h5>{{ __('Payable Amount') }} : {{ $booking->currency_symbol }}
        ...
        @elseif(!isset($booking_value) && $booking->payment_type == 'paytm')
            <div class="paytm">
                <p>{{ __('Make Payment') }}</p>
        ...
        @elseif(!isset($booking_value) && $booking->payment_type == 'flutterwave')
        ...
        @elseif(!isset($booking_value) && $booking->payment_type == 'paystack')
            <div class="paystack">
                <p>{{ __('Make Payment') }}</p>
                {!! Form::hidden('payment_id', null, ['id' => 'payment_id']) !!}
                <h5>{{ __('Payble Amount') }} : {{ $booking->currency_symbol }}
        ...
        @elseif(!isset($booking_value) && $booking->payment_type == 'coingate')
            <div class="coingate">
                <p>{{ __('Make Payment') }}</p>
                {!! Form::hidden('payment_id', null, ['id' => 'payment_id']) !!}
                <h5>{{ __('Payble Amount') }} : {{ $booking->currency_symbol }}
        ...
        @elseif(!isset($booking_value) && $booking->payment_type == 'mercado')
            <div class="mercado">
                <p>{{ __('Make Payment') }}</p>
                {!! Form::hidden('payment_id', null, ['id' => 'payment_id']) !!}
                <h5>{{ __('Payble Amount') }} : {{ $booking->currency_symbol }}
        ...
        @elseif(!isset($booking_value) && $booking->payment_type == 'payumoney')
            <div class="payumoney">
                <p>{{ __('Make Payment') }}</p>
                {!! Form::hidden('payment_id', null, ['id' => 'payment_id']) !!}
                <h5>{{ __('Payble Amount') }} : {{ $booking->currency_symbol }}
        ...
        <div class="col cap">
            ...
            <div class="pb-0 mt-3 form-actions">
                <input type="hidden" name="booking_value_id"
                    value="{{ isset($booking_value) ? $booking_value->id : '' }}" id="booking_value_id">
            </div>
        </div>
    </div>
@endif
