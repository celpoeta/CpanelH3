...
@push('script')
    ...
    <script>
        ...
        $(document).on('click', 'input[name="payment_status"]', function() {
            if ($(this).is(':checked')) {
                $(".paymenttype").fadeIn(500);
                $('.paymenttype').removeClass('d-none');
                $('.paymenttype').find('select[name="payment_type"]').attr('required', true);
            } else {
                $(".paymenttype").fadeOut(500);
                $('.paymenttype').addClass('d-none');
                $('.paymenttype').find('select[name="payment_type"]').attr('required', false);
            }
        });
