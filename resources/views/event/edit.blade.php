    ...
    <div class="row">
        <div class="col-md-12">
            @if (Auth::user()->type == 'Admin')
                <div class="form-group">
                    ...
                    {{ Form::select('user[]', $users, $selected_users, ['id' => 'user', 'required', 'class' => 'form-select', 'multiple', 'data-trigger']) }}
                </div>
            @endif
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::text('start_date', $start_date, ['class' => 'form-control ', 'placeholder' => __('Enter start date'), 'id' => 'start_date']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('end_date', __('End Date'), ['class' => 'form-label']) }}
                {{ Form::text('end_date', $end_date, ['class' => 'form-control ', 'placeholder' => __('Enter end date'), 'id' => 'end_date']) }}
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
